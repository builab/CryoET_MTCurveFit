...
NOT WORKING HAVE PROBLEM WITH PANDAS
...
def parse_arguments():
    ...
    if len(sys.argv) < 2:
        print("Usage: runscript mtfitchimerax.py <input_model_id> [voxelSize <value> minseed <value> sampleStep <value> poly <value> cleanDistThres <value> distExtrapolate <value> overlapThres <value>]")
        sys.exit(1)
